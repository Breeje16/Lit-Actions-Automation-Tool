...
const Footer = () => {
  return (
    <div>
        <footer className="text-gray-400 bg-gray-900 body-font relative bottom-0 right-0 left-0 ">
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <Link href={'/'}className="flex title-font font-medium items-center md:justify-start justify-center text-white">
      {/* <Image src="/logo_purple.png" alt="PasswordHut Logo" width={200} height={40} /> */}
      <h2>LOGO</h2>
    </Link>
    <p className="text-sm text-gray-300 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-300 sm:py-2 sm:mt-0 mt-4 md:text-lg">© 2022 Lit Automation Tool —
      <a href="https://twitter.com/LitProtocol" className="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">Powered by Lit Protocol</a>
    </p>
