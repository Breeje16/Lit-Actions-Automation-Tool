...
import { connectLitContracts, getMintCost, mintPKP } from '../utils/contracts';
import { hexToDecimal } from '../utils/helpers';
import { useSigner } from 'wagmi';
import {GrTrigger} from 'react-icons/gr';

const CreateLitActions = () => {
  ...
  async function handleMint() {
    ...
    try {
      const connect = connectLitContracts(signer);
      ...
      const pubKey = getPubkey(tokenId);
      setpubKey(pubKey);
  ...
  return (
    <main className="container">
      {!token &&
      <div className="flex flex-col items-center m-24 p-12 justify-center">
        <h1 className=" text-white text-center my-4 text-4xl">Create a cloud wallet</h1>
        <p className='text-center text-gray-200 my-4'>You&apos;ll need a cloud wallet to interact with this demo.</p>
        <button className="my-4 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" onClick={handleMint}>
          Mint one
        </button>
      </div>}.0
      {token &&
            ...
            <div className="bg-gray-900 px-2 lg:px-4 py-2 lg:py-10 sm:rounded-xl flex lg:flex-col justify-between">
              <nav className="flex items-center flex-row space-x-2 lg:space-x-0 lg:flex-col lg:space-y-2">
                <a className="text-white/50 p-4 inline-flex justify-center rounded-md hover:bg-gray-800 hover:text-white smooth-hover" href="/">
                  <GrTrigger color='#FFFFFF' className="w-8 h-8 rounded-lg p-1"  />
                </a>
                ...
                <div className="inline-flex items-center space-x-2">
                  <a className="bg-gray-900 text-white/50 p-2 rounded-md hover:text-white smooth-hover" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                    </svg>
                  </a>
                  <a className="bg-gray-900 text-white/50 p-2 rounded-md hover:text-white smooth-hover" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                    </svg>
                  </a>
                </div>
              </div>
                ...
                <div className="group bg-gray-900/30 py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/40 hover:smooth-hover">
                  <a className="bg-gray-900/70 text-white/50 group-hover:text-white group-hover:smooth-hover flex w-20 h-20 rounded-full items-center justify-center" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" strokeLinejoin="round" stroke-width="1" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                  </a>
...
export default CreateLitActions